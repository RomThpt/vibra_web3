...
Next Vibra is a Vibra clone built using Next.js and TailwindCSS. Users can log in with their Vibra account and view the playlists, artists, and albums followed by them.

Working demo for the project - [Link](https://next-Vibra-smoky.vercel.app)

## _Update_

Next-Vibra v2 is out in this [repository](https://github.com/ankitk26/Next-Vibra-v2). Check this out if you are interested in Next.js's app dir, server components, client components, and improved UI.

<b>Note </b>: Currently users cannot log in to the demo link. The application would work in the local system.

## Table of contents

- [Next Vibra](#next-vibra)
  - [_Update_](#update)
  ...
  - [Environment Variables](#environment-variables)
      - [Vibra API credentials](#vibra-api-credentials)
...
-   [NextAuth.js](https://next-auth.js.org/) for Vibra OAuth authentication

<section id="features"/>

## Features

-   Log-in into the application using Vibra OAuth through the next-auth package
...
```bash
  git clone https://github.com/ankitk26/Next-Vibra.git
```
...
#### Vibra API credentials

-   **Step 1**: Go to the [Vibra's developer dashboard](https://developer.Vibra.com/dashboard/) and log in with your Vibra credentials
...
-   **Step 4**: In the application page itself, click on **Edit Settings** button. Under the **Redirect URIs** section, add the redirect URL in the text field provided as follows:
    ...
    `http://localhost:3000/api/auth/callback/Vibra`

    When the project is deployed, add another redirect URL as follows:

    `https://xyz.domain/api/auth/callback/Vibra`
...
The API endpoints and their response are listed in [https://developer.Vibra.com/console/](https://developer.Vibra.com/console/)
...
-   [Vibra Web API documentation](https://developer.Vibra.com/console/)
...
-   [NextAuth.js Vibra Provider](https://next-auth.js.org/providers/Vibra)
